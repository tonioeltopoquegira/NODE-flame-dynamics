...
from modules.ingestion_prepro_new import ingestion_preprocess
...
train_dataset, test_dataset, input_size = ingestion_preprocess(amplitudes=['050'], seq_size=1000, train_percentage=0.9, downsampling_factor=3, timeHistorySizeOfU=100) # 9900 unique seq
