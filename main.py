...
from models.mlp_deepOnet import mlp as mlp_deepOnet
from models.mlp_basic import mlp as mlp_basic
from models.mlp_attention import mlp as mlp_att

model_name = 'mlp_att_lin'
...
train_model(train_dataset, model, 300, model_name = model_name, path=path, batch_size=600, scheduler=False, learning_rate=0.005, print_every=1)
